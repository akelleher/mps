...
;	C:\Users\John\Documents\MPS\lab1\Hello.c:47: SFRPAGE = UART0_PAGE;               // Direct output to UART0
	mov	_SFRPAGE,#0x00
	C$Hello.c$49$1$23 ==.
;	C:\Users\John\Documents\MPS\lab1\Hello.c:49: printf("\033[33;44m");              // yellow text; blue background
	mov	a,#___str_0
	push	acc
	mov	a,#(___str_0 >> 8)
	push	acc
	...
	dec	sp
	C$Hello.c$50$1$23 ==.
;	C:\Users\John\Documents\MPS\lab1\Hello.c:50: printf("\033[2J");                  // Erase screen & move cursor to home position
	mov	a,#___str_1
	push	acc
	mov	a,#(___str_1 >> 8)
	push	acc
	...
	dec	sp
	C$Hello.c$53$1$23 ==.
;	C:\Users\John\Documents\MPS\lab1\Hello.c:53: printf("\033[12;0H");               // Position cursor to print unprintables
	mov	a,#___str_2
	push	acc
	mov	a,#(___str_2 >> 8)
	push	acc
	...
	dec	sp
	C$Hello.c$54$1$23 ==.
;	C:\Users\John\Documents\MPS\lab1\Hello.c:54: printf("\033[s");
	mov	a,#___str_3
	push	acc
	mov	a,#(___str_3 >> 8)
	push	acc
	...
	dec	sp
	C$Hello.c$57$1$23 ==.
;	C:\Users\John\Documents\MPS\lab1\Hello.c:57: printf("\033[2;25H");               // Position cursor to print instructions
	mov	a,#___str_4
	push	acc
	mov	a,#(___str_4 >> 8)
	push	acc
	...
	dec	sp
	C$Hello.c$59$1$23 ==.
;	C:\Users\John\Documents\MPS\lab1\Hello.c:59: printf("Type <ESC> to end the program.\n\n\r");
	mov	a,#___str_5
	push	acc
	mov	a,#(___str_5 >> 8)
	push	acc
	...
	dec	sp
	C$Hello.c$61$1$23 ==.
;	C:\Users\John\Documents\MPS\lab1\Hello.c:61: printf("\033[6;0H");                // Position cursor to print Keyboard character info
	mov	a,#___str_6
	push	acc
	mov	a,#(___str_6 >> 8)
	push	acc
	...
	dec	sp
	C$Hello.c$63$1$23 ==.
;	C:\Users\John\Documents\MPS\lab1\Hello.c:63: printf("The keyboard character is  .");
	mov	a,#___str_7
	push	acc
	mov	a,#(___str_7 >> 8)
	push	acc
	...
	dec	sp
	C$Hello.c$65$1$23 ==.
;	C:\Users\John\Documents\MPS\lab1\Hello.c:65: printf("\033[12;25r");              // Set scroll region
	mov	a,#___str_8
	push	acc
	mov	a,#(___str_8 >> 8)
	push	acc
	...
	dec	sp
	C$Hello.c$67$2$24 ==.
;	C:\Users\John\Documents\MPS\lab1\Hello.c:67: while(1)
00107$:
	C$Hello.c$69$2$24 ==.
;	C:\Users\John\Documents\MPS\lab1\Hello.c:69: printf("\033[6;27H"); //position cursor where keyboard character is to be displayed
	mov	a,#___str_9
	push	acc
	mov	a,#(___str_9 >> 8)
	push	acc
	...
	dec	sp
	C$Hello.c$70$2$24 ==.
;	C:\Users\John\Documents\MPS\lab1\Hello.c:70: printf("\033[37m"); // white text
	mov	a,#___str_10
	push	acc
	mov	a,#(___str_10 >> 8)
	push	acc
	...
	dec	sp
	C$Hello.c$76$2$24 ==.
;	C:\Users\John\Documents\MPS\lab1\Hello.c:76: choice = getchar();
	lcall	_getchar
	mov	r7,dpl
	C$Hello.c$79$2$24 ==.
;	C:\Users\John\Documents\MPS\lab1\Hello.c:79: P1 |= 0x40;                     // Turn green LED on
	orl	_P1,#0x40
	C$Hello.c$80$2$24 ==.
;	C:\Users\John\Documents\MPS\lab1\Hello.c:80: if (choice == '\033'){
	cjne	r7,#0x1b,00102$
	C$Hello.c$81$3$25 ==.
;	C:\Users\John\Documents\MPS\lab1\Hello.c:81: return;
	ljmp	00109$
00102$:
	C$Hello.c$84$2$24 ==.
;	C:\Users\John\Documents\MPS\lab1\Hello.c:84: if (!(choice >= '\040' && choice <= '\176')){ //If not a printable character
	cjne	r7,#0x20,00122$
00122$:
	jc	00103$
	mov	a,r7
...
00103$:
	C$Hello.c$85$3$26 ==.
;	C:\Users\John\Documents\MPS\lab1\Hello.c:85: printf("\033[5;33;44m");          // yellow text; blue background
	push	ar7
	mov	a,#___str_11
	push	acc
	mov	a,#(___str_11 >> 8)
	...
	dec	sp
	C$Hello.c$86$3$26 ==.
;	C:\Users\John\Documents\MPS\lab1\Hello.c:86: printf("\033[u");               // Position cursor to print Keyboard character info
	mov	a,#___str_12
	push	acc
	mov	a,#(___str_12 >> 8)
	push	acc
	...
	dec	sp
	C$Hello.c$88$3$26 ==.
;	C:\Users\John\Documents\MPS\lab1\Hello.c:88: printf("The keyboard character $%02X is \033[4m'not printable'\033[0;5;33;44m.\n\r", choice);
	mov	r6,#0x00
	push	ar6
	mov	a,#___str_13
	push	acc
	...
	mov	sp,a
	C$Hello.c$89$3$26 ==.
;	C:\Users\John\Documents\MPS\lab1\Hello.c:89: printf("\007");                 //sound bell
	mov	a,#___str_14
	push	acc
	mov	a,#(___str_14 >> 8)
	push	acc
	...
	dec	sp
	C$Hello.c$91$3$26 ==.
;	C:\Users\John\Documents\MPS\lab1\Hello.c:91: printf("\033[0m");          // yellow text; blue background
	mov	a,#___str_15
	push	acc
	mov	a,#(___str_15 >> 8)
	push	acc
	...
	dec	sp
	C$Hello.c$92$3$26 ==.
;	C:\Users\John\Documents\MPS\lab1\Hello.c:92: printf("\033[33;44m");          // yellow text; blue background
	mov	a,#___str_0
	push	acc
	mov	a,#(___str_0 >> 8)
	push	acc
	...
	dec	sp
	C$Hello.c$94$3$26 ==.
;	C:\Users\John\Documents\MPS\lab1\Hello.c:94: printf("\033[s");               // Position cursor to print Keyboard character info
	mov	a,#___str_3
	push	acc
	mov	a,#(___str_3 >> 8)
	push	acc
	...
	dec	sp
	C$Hello.c$95$3$26 ==.
;	C:\Users\John\Documents\MPS\lab1\Hello.c:95: printf("\033[6;27H ");          //overwrite unprintable charactar with space
	mov	a,#___str_16
	push	acc
	mov	a,#(___str_16 >> 8)
	push	acc
