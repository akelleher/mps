...
S:LportIO.getchar$c$1$17({1}SC:U),R,0,0,[]
S:LportIO.main$choice$1$23({1}SC:U),E,0,0
S:LportIO.main$sloc0$1$0({2}SI:S),E,0,0
S:LportIO.main$sloc1$1$0({2}SI:S),E,0,0
S:LportIO.main$sloc2$1$0({2}SI:S),E,0,0
S:LportIO.main$sloc3$1$0({2}SI:S),E,0,0
S:LportIO.main$sloc4$1$0({2}SI:S),E,0,0
S:LportIO.main$sloc5$1$0({2}SI:S),E,0,0
S:LportIO.main$sloc6$1$0({2}SI:S),E,0,0
S:LportIO.main$sloc7$1$0({2}SI:S),E,0,0
S:LportIO.main$sloc8$1$0({2}SI:S),E,0,0
S:LportIO.main$sloc9$1$0({2}SI:S),E,0,0
S:LportIO.main$sloc10$1$0({2}SI:S),E,0,0
S:LportIO.main$sloc11$1$0({2}SI:S),E,0,0
S:LportIO.main$sloc12$1$0({2}SI:S),E,0,0
S:LportIO.main$sloc13$1$0({2}SI:S),E,0,0
...
S:FportIO$__str_0$0$0({9}DA9d,SC:S),D,0,0
S:FportIO$__str_1$0$0({5}DA5d,SC:S),D,0,0
S:FportIO$__str_2$0$0({15}DA15d,SC:S),D,0,0
S:FportIO$__str_3$0$0({64}DA64d,SC:S),D,0,0
