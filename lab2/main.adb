...
S:Lmain.getchar$c$1$17({1}SC:U),R,0,0,[]
S:Lmain.main$SFRPAGE_SAVE$1$24({1}SC:U),R,0,0,[r7]
S:G$SW2press$0$0({1}SB0$1:U),H,0,0
S:Lmain.main$restart$1$24({1}SB0$1:U),R,0,0,[]
...
S:Fmain$__str_1$0$0({29}DA29d,SC:S),D,0,0
S:Fmain$__str_2$0$0({50}DA50d,SC:S),D,0,0
S:Fmain$__str_3$0$0({28}DA28d,SC:S),D,0,0
